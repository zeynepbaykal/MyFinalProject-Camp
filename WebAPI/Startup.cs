...
namespace WebAPI
{
    public class Startup
    {
        ...
        {
            //Autofac(Bize "AOP" imkaný sunar.), Ninject, CastleWinder,StructureMap,LightInject,DryInject-----> IoC Container
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.ConfigureCustomExceptionMiddleware(); //rent car projene de ekle
